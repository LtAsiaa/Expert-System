...
(defrule Conclusion-The-sandlot ""
	...
	(assert (UI-state (display Conclusion-The-sandlot)
					  (relation-asserted Conclusion-The-sandlot)
					  (valid-answers peffercorn))))
			
(defrule Conclusion-Rookie-of-the-year ""
	(logical ( Conclusion-The-sandlot peffercorn))
	=>
	(assert (UI-state (display Conclusion-Rookie-of-the-year)
					  (relation-asserted Conclusion-Rookie-of-the-year)
					  (valid-answers sleep))))
...
(defrule Conclusion-The-princess-bride ""
	...
	(assert (UI-state (display Conclusion-The-princess-bride)
					  (relation-asserted Conclusion-The-princess-bride)
					  (valid-answers greatestmov))))
					  
(defrule Conclusion-Fantasia ""
	(logical (dialog No))
	=>
	(assert (UI-state (display Conclusion-Fantasia)
					  (relation-asserted Conclusion-Fantasia)
					  (valid-answers old))))
;;;****************
;;;* FINAL RULES *
;;;****************
...
(defrule Conclusion-Little-big-league ""
	(logical (Conclusion-Rookie-of-the-year sleep))
	=>
